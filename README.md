...
O arquivo "dados-atletas.js" não tem a saída da altura, visto que na lista de médodos da classe não é informado a necessidade do mesmo. Porém, o "Exemplo de saída" mostra a informação da altura saindo, então fiz o arquivo "dados-atletas-com-altura.js" caso tenha essa necessidade.

Do curso vieram as seguintes informações:
